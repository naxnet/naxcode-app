...
# users_course_assignment_assignment_user_index POST   /users/courses/:course_id/assignments/:assignment_id/assignment_user(.:format)           users/assignment_user#create
#   new_users_course_assignment_assignment_user GET    /users/courses/:course_id/assignments/:assignment_id/assignment_user/new(.:format)       users/assignment_user#new
#       users_course_assignment_assignment_user GET    /users/courses/:course_id/assignments/:assignment_id/assignment_user/:id(.:format)       users/assignment_user#show
  ...
  namespace :users do
    resources :courses, only: [:index, :show, :destroy] do
      ...
      resources :assignments, only: [:index, :show] do
        resources :assignment_user, only: [:new, :create, :show]
      end
    end
  end
