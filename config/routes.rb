...
#            result_users_course_assignment_assignment_user POST   /users/courses/:course_id/assignments/:assignment_id/assignment_users/:id/result(.:format)            users/assignment_users#result
#        result_zip_users_course_assignment_assignment_user POST   /users/courses/:course_id/assignments/:assignment_id/assignment_users/:id/result_zip(.:format)        users/assignment_users#result_zip
# compilation_error_users_course_assignment_assignment_user POST   /users/courses/:course_id/assignments/:assignment_id/assignment_users/:id/compilation_error(.:format) users/assignment_users#compilation_error
